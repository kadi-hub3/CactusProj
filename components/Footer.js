...
const Footer = () => {
  return (
    <footer className="h-43 xl:h-40 w-screen items-center justify-items-center grid grid-rows-3 xl:grid-cols-3 gap-y-10 gap-x-20 py-14 bg-gray-900 z-10">
      <h3 className="font-serif text-lg xl:text-xl text-white font-bold tracking-wide xl:tracking-wider">
        Alessio Muggani
      </h3>
      <ul className="flex justify-around text-white text-lg xl:text-xl tracking wide xl:tracking-widest">
